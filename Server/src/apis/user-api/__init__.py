...
from .handlers import get_current_user_info_handler, fetch_user_handler, update_user_handler,get_user_info_handler,change_password_handler
...
routes = [
    ...
    dict(auth_required=True,
         path='/password',
         view_func=change_password_handler,
